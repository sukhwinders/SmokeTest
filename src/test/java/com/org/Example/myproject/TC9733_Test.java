...
public class TC9733_Test {
	...
	//String Reqname = "AutoTestWed Nov 23 11:14:55 IST 2016";
	...
	public void Approve_Request() throws Exception {
		...
		CreateNewForm();
		Thread.sleep(5000);
		System.out.println("Before Send - " + Reqname);
		guitils.SendRequest(driver, Reqname, Responder, FormName, comment);
		System.out.println("After Send - " + Reqname);
		// code for logout
		...
		System.out.println("Before fill form - " + Reqname);
		guitils.FillFormAndSubmitRequest(driver, Reqname, comment,PartialContainer);
		System.out.println("After fill form - " + Reqname);
		...
		System.out.println("Before Approve - " + Reqname);
		guitils.ApproveRequest(driver, Reqname, PartialReq);
		System.out.println("After Approve - " + Reqname);
