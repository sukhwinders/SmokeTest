		   ...
		   public void create_Questions() throws InterruptedException  { 
			...
			//picklist 
			   ...
			   for(int i=0; i<=5; i++)
			   {
			    ...
			    Thread.sleep(5000);
			    //passing Parameters
				driver.findElement(By.xpath("//input[@id='j_id0:form:answerOptionBlock:answerOptionSection:answerOptionTable:"+i+":j_id166']")).sendKeys("Pick "+i);
				driver.findElement(By.xpath("//input[@id='j_id0:form:answerOptionBlock:answerOptionSection:answerOptionTable:"+i+":j_id170']")).sendKeys("T"+i);
			   }
			   
			    Actions act = new Actions(driver);
			    act.moveToElement(driver.findElement(By.id("j_id0_form_answerOptionBlock_answerOptionSection_answerOptionTable_0_j_id175_chkbox"))).doubleClick().build().perform();
			    driver.findElement(By.id("j_id0_form_answerOptionBlock_answerOptionSection_answerOptionTable_0_j_id175")).click(); 
