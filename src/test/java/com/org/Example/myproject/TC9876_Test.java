...
public class TC9876_Test {
	...
	public void createNew_form() throws Exception {
		...
		System.out
				.println("TC9876 : Verify create Custom Form using 1 Tab, 1 sections and 5 Questions (Scenario 48 -CF)");
	...
	public void create_Questions() throws InterruptedException {
		...
		driver.findElement(
				...
				.click();
		Thread.sleep(4000);
		driver.findElement(By.id("j_id0:form:linkedQuestionsBlock:linkedQuestionsSection:linkedQuestionsTable:0:selectElement")).click();
		Thread.sleep(6000);
		driver.findElement(
		...
		driver.findElement(
				...
				.click();
		Thread.sleep(5000);
		driver.findElement(By.id("j_id0:form:linkedQuestionsBlock:linkedQuestionsSection:linkedQuestionsTable:1:selectElement")).click();
		Thread.sleep(6000);
		driver.findElement(
				By.id("j_id0:form:answerOptionBlock:createAnswerOption"))
				.click();
		...
		// Date Time Question with 4 Values
				...
				driver.findElement(
						...
						.click();
				Thread.sleep(4000);
				driver.findElement(By.id("j_id0:form:linkedQuestionsBlock:linkedQuestionsSection:linkedQuestionsTable:2:selectElement")).click();
				Thread.sleep(6000);
				driver.findElement(
						By.id("j_id0:form:answerOptionBlock:createAnswerOption"))
						.click();
				...
				// Multipicklist Question with 4 Values
