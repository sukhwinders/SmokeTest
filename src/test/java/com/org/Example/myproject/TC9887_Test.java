...
public class TC9887_Test {
	...
	public void createTabs() throws InterruptedException {
		 ...
		 */
		driver.findElement(
				By.id("j_id0:form:tabBlock:tabSection:tabTable:1:j_id47"))
				.sendKeys("Tab2");
		// Send name for Tab 3
		/*
		 * driver.findElement(
		 ...
		 */
		driver.findElement(
				By.id("j_id0:form:tabBlock:tabSection:tabTable:2:j_id47"))
				.sendKeys("Tab3");
		// Send name for Tab 4
		/*
		 * driver.findElement(
		 ...
		 */
		driver.findElement(
				By.id("j_id0:form:tabBlock:tabSection:tabTable:3:j_id47"))
				.sendKeys("Tab4");
