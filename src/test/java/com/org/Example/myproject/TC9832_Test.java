	...
	@BeforeClass
	  ...
	  public void createNew_form() throws Exception {
	   ...
	   //Text 
	    ...
	    driver.findElement(By.xpath("//input[@id='input_searchLibraryQuestion']")).sendKeys("text");
	  ...
	  //Checkbox 
	    ...
	    Thread.sleep(3000);
	    driver.findElement(By.xpath("//input[@id='input_searchLibraryQuestion']")).clear();
	    driver.findElement(By.xpath("//input[@id='input_searchLibraryQuestion']")).sendKeys("checkbox");
