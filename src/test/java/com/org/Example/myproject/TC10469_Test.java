...
// Set Requirements 		
		...
		action.moveToElement(we1).moveToElement(driver.findElement(By.xpath("html/body/form/div["+i+"]/div[4]/section/div/div/slds-datepicker/div/div[2]/table/tbody/tr[5]/td[6]/span"))).click().build().perform();
