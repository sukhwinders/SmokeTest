...
public class DocumentLibraryRepo {
	...
	public static By btnAddDocument=By.id("btn_AddDocument");
	public static By browseLink=By.id("browseLink");
	public static By btnSave = By.id("documentDialogSaveButton");
	...
	public static By ResipentDrop = By.xpath("//h3[@style='font-weight: bold;']");
