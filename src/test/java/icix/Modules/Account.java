...
public class Account {
	...
	public void searchTPBy(String sendkey) throws Exception{
		...
		Common.ClickElement(AccountRepo.btnSearch, 10); // NewAdded 22Aug
		Common.assertText(AccountRepo.verifySearchResult, "We found 1 match in the ICIX Network.", 10); // NewAdded 22Aug
