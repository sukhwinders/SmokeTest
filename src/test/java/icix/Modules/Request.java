...
//		Assert.assertEquals(Common.FindAnElement(RequestRepo.SpanWorkFlowStatus).getText(), "Rejected by Requestor","Workflow status is not Approved");
			...
			throws Exception 
	{
		...
		Common.ClickElement(RequestRepo.lnkDocCategory, 1000);
	...
	// Commented On 29Aug
		...
		//Common.ClickElement(By.xpath("//div[@ng-bind-html='data.name'][contains(text(),'Automation form Tue Aug 29 15:53:06 IST 2017')]/preceding::span[1]"), 1000);
		Common.ClickElement(By.xpath("//div[@ng-bind-html='data.name'][contains(text(),'"+formName+"')]/preceding::span[1]"), 1000);

		Log.info("Form Selected");
