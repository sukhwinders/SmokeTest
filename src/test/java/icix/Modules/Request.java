...
public class Request {
	...
	public void VerifyRequestStatus(String status) throws InterruptedException
	{
		switch(status){
		...
		case "Open":
			...
			Common.doubleClick(By.xpath("//img[@class='checked']"), 3);
	...
	public void submitBackToRequestor(String RequestName,String ContainerName,String AttentionComments,String TestingFacility) throws InterruptedException{
		...
		Common.ClickElement(By.xpath("//div//following::a[@title='Show more actions for this record'][1]"), 120);
		Common.ClickElement(By.linkText("Submit"), 120);
