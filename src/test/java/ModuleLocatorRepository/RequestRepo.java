...
public class RequestRepo {
	...
	public String lnkRequest="//span[contains(text(),'Reports')][@class='label slds-truncate slds-text-link']/following::span[contains(text(),'Requests')]";
	...
	public String btnNew="//div[@title='New']";
	...
	public String btnFormClose="//button[@class='slds-button slds-button--neutral slds-button-space-left slds-float--right ng-scope']";

	public String btnYes="//button[contains(.,'Yes')]";
